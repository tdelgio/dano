...
const ContactForm = () => {
  return (
    <div className="bg-black h-screen">
      return (
      <>
        <div className="lg:-mt-16 mt-16 flex flex-col items-center justify-center h-full min-h-screen tracking-widest leading-6 bg-black text-gray-200">
          <div className="flex items-center justify-center flex-col mx-1 py-5  sm:py-10 tracking-widest border-2 border-gray-dark rounded-lg shadow-lg lg:p-8">
